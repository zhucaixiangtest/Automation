...
class Judge_use_case(Underlykey):
           ...
           #float
            ...
            # js弹窗
                ...
                self._prompts_js_key(driver,Location_element,Input_content)
                 ...
                 self._iframe_into_key(driver,Location_element)
                ...
                self._find_value_key(driver,Positioning_mode,Location_element,Input_content)
    ...
    def _case_selenium(self,driver,Operation_method,Positioning_mode,Location_element,Input_content,output):
            ...
            self._case_seleniums(driver,Operation_method,Positioning_mode,Location_element,Input_content,output)
